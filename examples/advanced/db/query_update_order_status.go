...
func (q *Queries) UpdateOrderStatus(ctx context.Context, status any, id any) (UpdateOrderStatusRow, error) {
	rows, err := q.db.QueryContext(ctx, queryUpdateOrderStatus, status, id)
	if err != nil {
